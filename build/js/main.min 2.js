...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Accordion
  var accordion = document.querySelectorAll('[data-div="accordion__title"]');
  var _loop = function _loop() {
    var accordionTitle = accordion[i];
    accordionTitle.addEventListener('click', function () {
      if (accordionTitle.classList.contains('is-open')) {
        ...
        accordionTitlesWithIsOpen.forEach(function (accordionTitleWithIsOpen) {
  ...
  var aboutButton = document.querySelector('[data-button="button"]');
  var aboutWrapper = document.querySelector('[data-about="about-wrapper"]');
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      this._openedModalElement = document.querySelector('.modal.is-active-modal');
